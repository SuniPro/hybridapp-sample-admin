...
public class CmmnConstant {
	...
	public static final String IMAGE_UPLOAD_DIR_EDITOR		= "mngr/editor/";
	public static final String IMAGE_UPLOAD_DIR				= "mngr/";
	...
	/* SER 서비스 시작일 */
	public static final String SER_START_DATE				= "2022-04-29";
	...
	public static void setIpInfo(DataClass params, HttpServletRequest request) {
		String ip = CmmnConstant.getRequestIP(request);
		params.set("isrt_ip", ip);
		params.set("updt_ip", ip);
	}
}
